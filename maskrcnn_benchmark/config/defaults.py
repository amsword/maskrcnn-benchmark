...
_C.INPUT.FIXED_SIZE_AUG.RANDOM_SCALE_MIN = 1.
_C.INPUT.FIXED_SIZE_AUG.RANDOM_SCALE_MAX = 1.
_C.INPUT.FIXED_SIZE_AUG.INPUT_SIZE = 800 # 800 x 800
_C.INPUT.FIXED_SIZE_AUG.TRIES = 50
_C.INPUT.FIXED_SIZE_AUG.JITTER = 0.2 # 0 for disabling
...
_C.MODEL.ROI_HEADS.NMS_POLICY = CN()
_C.MODEL.ROI_HEADS.NMS_POLICY.TYPE = 'nms' # nms or softnms
_C.MODEL.ROI_HEADS.NMS_POLICY.THRESH = 0.5
_C.MODEL.ROI_HEADS.NMS_POLICY.WH0 = 1
_C.MODEL.ROI_HEADS.NMS_POLICY.ALPHA = 0.5
_C.MODEL.ROI_HEADS.NMS_POLICY.GAMMA = 0.5
_C.MODEL.ROI_HEADS.NMS_POLICY.NUM = 2
_C.MODEL.ROI_HEADS.NMS_POLICY.ALPHA2 = 0.1
_C.MODEL.ROI_HEADS.NMS_POLICY.GAMMA2 = 0.1
_C.MODEL.ROI_HEADS.NMS_POLICY.NUM2 = 1
_C.MODEL.ROI_HEADS.NMS_POLICY.COMPOSE_FINAL_RERANK = False
...
_C.MODEL.RESNETS.CONVRESSTEM.RES_CHANNEL2 = 64
_C.MODEL.RESNETS.CONVRESSTEM.NUM_BLOCK_RES1 = 2
_C.MODEL.RESNETS.CONVRESSTEM.NUM_BLOCK_RES2 = 2
...
_C.MODEL.RETINANET.NMS_POLICY = CN()
_C.MODEL.RETINANET.NMS_POLICY.TYPE = 'nms' # nms or softnms
_C.MODEL.RETINANET.NMS_POLICY.THRESH = 0.4
_C.MODEL.RETINANET.NMS_POLICY.WH0 = 1
_C.MODEL.RETINANET.NMS_POLICY.ALPHA = 0.4
_C.MODEL.RETINANET.NMS_POLICY.GAMMA = 0.4
_C.MODEL.RETINANET.NMS_POLICY.NUM = 1
_C.MODEL.RETINANET.NMS_POLICY.THRESH2 = 0.4
_C.MODEL.RETINANET.NMS_POLICY.ALPHA2 = 0.1
_C.MODEL.RETINANET.NMS_POLICY.GAMMA2 = 0.1
_C.MODEL.RETINANET.NMS_POLICY.NUM2 = 0
_C.MODEL.RETINANET.NMS_POLICY.COMPOSE_FINAL_RERANK = False
_C.MODEL.RETINANET.NMS_POLICY.COMPOSE_FINAL_RERANK_TYPE = 'nms'
